...
Firebase deployments are handled automatically following [Continuous Integration Continuous Development](ci_cd) practices using GitHub Actions. Here we will connect create custom actions that are connected to the task's Firebase project.
