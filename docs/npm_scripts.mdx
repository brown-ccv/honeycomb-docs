...
- `cli` runs Honeycomb's CLI script for downloading and deleting data. It currently only works with Firebase - see [here](firebase#downloading-and-deleting-data) for more!
