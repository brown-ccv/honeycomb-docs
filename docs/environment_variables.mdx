...
description: Overview of environemnt variables used by Honeycomb
---
...
The `dotenv-cli` comes with the `dotenv` command that can be used to properly load the needed variables. We write our npm scriptswith the following format:
