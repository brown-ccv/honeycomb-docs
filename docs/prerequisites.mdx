...
All of the required dependencies for Honeycomb on MacOS can be installed via the brewfile. See the [quick start](quick_start.mdx/#installing-prerequisites-with-homebrew-for-macos) for more information.
