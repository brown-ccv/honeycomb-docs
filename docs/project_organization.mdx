...
The `package.json` file contains metadata about your project, a list of the dependency needed for the project, and scripts to run tasks related to your task. The [Quick Start](quick_start#4-change-name-and-description) lists which metadata should be changed.
