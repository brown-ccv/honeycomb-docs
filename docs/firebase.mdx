...
1. Select whether you would like to download or delete data
2. Enter the ID of a given study
3. Enter the ID of a given participant on that study
4. Select the sessions to download/delete
   :::info
...
_The download script will additionally ask where the data should be stored. The deletion script will ask for confirmation whenever deleting files._
