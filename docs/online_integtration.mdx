...
To automate firebase deployments, we have included instructions on setting up firebase github actions on our [Automated Builds page](CI.mdx#github-actions-for-firebase-hosting)
