...
1. `name` should be updated to your task's name
2. `description` should be updated to better match your task
3. `author` should be updated to your lab name, email, and webpage
4. `version` should be reset to 1.0.0
5. `repository` should be set to the GitHub repository you created [earlier](quick_start#2-start-your-new-task-from-our-template-repository)
