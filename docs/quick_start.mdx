...
1. Create your task from a template
2. Clone the repository
3. Install the prerequisites (tab for OS specific command, point to pre-requisites page for issues/more details)
4. Run npm install
5. Run npm run dev
6. Quit the task
7. Change name and description (don't need details about the parts of the file)
8. Next Steps (check out the data, firebase install, etc.)
...
Additional details about template repositories can be found on the [Github Docs](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template).
...
The [winget](https://learn.microsoft.com/en-us/windows/package-manager/winget/) package manager is available on Windows 10 and Windows 11.
